            ...
            <div class="jive-message-list">
              <div class="jive-table">
                ...
                for (int i = 0; i< articles.size(); i++){
                	...
                	String floor = i == 0?"Poster" : "The " + i + " floor";
                 %>
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="reply.jsp?id=<%=a.getId() %>&rootId=<%=a.getRootId() %>" title="回复本主题"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a> </td>
