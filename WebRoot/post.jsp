...
<%@ page import="java.sql.*,com.db.*,  java.util.*"%>

<%
	request.setCharacterEncoding("GB18030");
	String action = request.getParameter("action");
	//new String(request.getParameter("action").getBytes("8859_1"), "GBK");
	if (action != null && action.trim().equals("post")) {
		//	byte[] bytes1=request.getParameter("title").getBytes("8859_1");
			//String title = new String(bytes1, "GBK");
			String title = new String(request.getParameter("title").getBytes("8859_1"),"GBK");
	//	String title = new String(request.getParameter("title").getBytes("8859_1"), "GBK");
		System.out.println(title);
		byte[] bytes2=request.getParameter("cont").getBytes("8859_1");
			String cont = new String(bytes2, "GBK");
		//String cont = new String(request.getParameter("cont").getBytes("8859_1"), "GBK");
									...
									<div class="jive-table">
										<div class="jive-messagebox">
											...
											<form action="post.jsp" method="post">
												...
												<br>
												内容：
												<textarea cols="80" id="cont" name="cont" rows="10"></textarea>
                				<script>
